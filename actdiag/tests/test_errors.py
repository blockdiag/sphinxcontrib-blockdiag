...
class TestSphinxcontribActdiagErrors(unittest.TestCase):
    def setUp(self):
        self.app = FakeSphinx()
        sphinxcontrib.actdiag.setup(self.app)
    ...
    @with_app(srcdir='docs/basic', confoverrides=dict(actdiag_html_image_format='JPG'))
    ...
    @with_app(srcdir='docs/basic', confoverrides=dict(actdiag_html_image_format='PDF'))
